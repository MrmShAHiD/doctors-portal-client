...
function NavBar() {
    return (
        <nav className="navbar navbar-expand-lg navbar-light">
            <a class="navbar-brand" href="/"> <img style={{width:'100px'}} class="logo img-fluid" src={logo} alt=""/><i><b> BRB Hospital Ltd.</b></i></a>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item active">
                        <a className="nav-link mr-5" href="#">Appointments<span className="sr-only">(current)</span></a>
                    </li>
